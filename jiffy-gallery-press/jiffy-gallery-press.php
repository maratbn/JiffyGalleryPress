...
/*
  ...
  Description: Setup image galleries in a jiffy via shortcodes.  No locked premium features.
...
const PLUGIN_VERSION = '1.0.0-development_unreleased_candidate';
    ...
    ?><li><?php
      ...
      ?><div class='jiffy_gallery_press__post'><?php
        ...
        ?><a href='<?=\esc_url_raw(\get_edit_post_link($post->ID))?>' target='_blank'><?php
          ?><?=$post->post_name?><?php
        ?></a><?php
        ?><ul class='jiffy_gallery_press__shortcodes'><?php
          $arrMatchesShortcode = _getMatchesInContent($strContent);
